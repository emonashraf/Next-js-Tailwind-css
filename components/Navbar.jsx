        ...
        >
          ...
          <div>
            <ul className="uppercase py-4 flex flex-col">
              <Link href="/">
                <li className="my-4 text-sm">Home</li>
              </Link>
              <Link href="/">
                <li className="my-4 text-sm">About</li>
              </Link>
              <Link href="/">
                <li className="my-4 text-sm">Skills</li>
              </Link>
              <Link href="/">
                <li className="my-4 text-sm">Project</li>
              </Link>
              <Link href="/">
                <li className="my-4 text-sm">Contact</li>
              </Link>
            </ul>
            <div className="pt-40">
